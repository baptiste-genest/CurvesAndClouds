...
#include "../LIFAP6_TP5/hash_table.h"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    std::function<void(uint,BinarySearchTree&)> testBST = [values] (uint n,BinarySearchTree& BST){
        for (uint k = 0;k<n;k++)
            BST.insert(values[k]);
        BST.clear();
    };
    ...
    display_benchmark<BinarySearchTree>(G,BTS,testBST,ts);
